...
def pdfToDocx(filename, remote_name, output_name):
        ...
        print("Download path: ", app.config['DOWNLOAD_FOLDER'])
        ...
        try:
                ...
                print("file path: ",app.config['DOWNLOAD_FOLDER']+ output_name)
                copyfile(response_download,
                        app.config['DOWNLOAD_FOLDER']+ output_name)
                
                # alternative of  response_download.rsplit('\\',1)[1].replace(';','')
                print("Successful")
